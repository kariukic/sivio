...
def add_phase_offsets(ms):
    ...
    #phase1 = ant1_coef[:,:,0] + ant1_coef[:,:,1] * l * uvw_lmbdas[:, :, 0]  + ant1_coef[:,:,2]*m*uvw_lmbdas[:, :, 1] * uvw_lmbdas[:, :, 2] * n
    # phase2 = ant2_coef[:,:,0] + ant2_coef[:,:,1] * l * uvw_lmbdas[:, :, 0]  + ant2_coef[:,:,2]*m*uvw_lmbdas[:, :, 1] * uvw_lmbdas[:, :, 2] * n
